const CnLv9MasterDb = [
  ...
  },
  {
    ...
    disciples: ['Tiantai Deshao', 'Quy Tông Nghĩa Nhu (Guizong Yirou, 歸宗義柔)',  'Chongshou Qichou',
      'Baizhang Daoheng - Bách Trượng Đạo Hằng (百丈道恆,?-991/992)', 'Guizong Xuance',
      ...
      'Tiến Phước THIỆU MINH - Tô Châu', 'Cổ Hiền Cẩn - Trạch Châu', 'KHẢ HUÂN Viện Hưng Phước - Tuyên Châu', 
      'THỦ NỘT Viện Thượng Lam - Hồng Châu', 'PHÚC THOÀN', 'PHỔ MINH PHÁP HOÀI', 
      'TUỆ LÃNG Chùa Hóa Thành - Lô Sơn', 'ĐẠO HỒNG THÔNG BIỆN - Chùa Tuệ Nhật Vĩnh Minh Hàng Châu', 'LINH GIÁM (CAO LY)',
      'TUYỀN - KINH MÔN', 'TĂNG ĐỘN - Chùa Đại Lâm Lô Sơn', 'DUYÊN THẮNG - Viện Nhân Vương Trì Châu',
