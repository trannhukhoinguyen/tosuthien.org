const CnLv20MasterDb = [
  ...
  {
    id: '53.20.9',
    name_en: 'Xindi Juexin',
    name_ja: 'Shinchi Kakushin',
    other_name_ja: 'Muhon Kakushin',
    name_zh: '心地覺心',
    name_vi: 'Tâm Địa Giác Tâm',
    other_name_vi: 'Vô Bản Giác Tâm',
    birth_death_time: ['', ''],
    sect: ['Linji', 'Yangqi', 'Hottō-ha'],
    country: '🇨🇳',
    place: '',
    teachers: ['Wumen Huikai'],
    disciples: [''],
    image: '/images/buddha-zen-circle-with-unknown-zen-master.avif',
    reference: ['',],
  },
